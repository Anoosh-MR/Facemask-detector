...
public class custom_image extends BaseAdapter {
    ...
    public custom_image(Context applicationContext, ArrayList<String> a, ArrayList<String> b) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        try {
            ...
            thumb_u = new java.net.URL("http://"+sh.getString("ip","")+":5000/static/pic/"+a.get(position));
